...
tellraw @a {"rawtext":[{"text":"§l§4人狼§f:§e"},{"selector":"@a[scores={role=1}]"}]}
execute if score "狂人" roleList matches 1.. run tellraw @a {"rawtext":[{"text":"§l§7狂人§f:§e"},{"selector":"@a[scores={role=2}]"}]}
