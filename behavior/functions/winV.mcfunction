...
execute if score "市民" roleList matches 1.. run tellraw @a {"rawtext":[{"text":"§a市民§f:§e"},{"selector":"@a[scores={role=3}]"}]}
execute if score "霊媒師" roleList matches 1.. run tellraw @a {"rawtext":[{"text":"§3霊媒師§f:§e"},{"selector":"@a[scores={role=4}]"}]}
execute if score "占い師" roleList matches 1.. run tellraw @a {"rawtext":[{"text":"§5占い師§f:§e"},{"selector":"@a[scores={role=5}]"}]}
